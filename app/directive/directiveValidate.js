...
var msg = {
    "form": {
        ...
        isMobile: 'Please enter the correct mobile number',//'لطفا شماره موبایل را به صورت صحیح وارد نمایید.',
        percent: 'تنها اعداد بین 1 تا 100 صحیح است.',
        profileUser: 'رمز قبلی را اشتباه وارد کردید'
    }
};

//---------------------------------------------توابع اعتبار سنجی  functions for validate-------------------------------------------------------
